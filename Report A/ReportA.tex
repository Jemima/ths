...
%TODO: Frequency instead of critical path length or latency. Register stages vs critical path.
% More detailed results as appendix.
% Leave out irrelevant results (e.g. inputs/output elements)
% Be careful of wording for feedback loops
% Tables - Headers more concise, use percenmtages not scale factors, more lines to make them look nicer
