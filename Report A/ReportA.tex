...
\newpage\fxnote{newpage is just here to fix formatting}
...
\newpage\fxnote{newpage just her to fix formatting}
...
pdc 200 width   & N/A   & 300\% & 176\% & 104\% & 301\% &  75\% & 425\%\\
          \bottomrule
        \end{tabularx}
        \caption{Circuit characteristics of benchmark with greatest frequency slowdown, expressed as a percentage of non \ac{TMR} base\fxwarning{TODO: Make this clearer for this and \ref{timing}}}
        \label{timing2}
    \end{adjustwidth}
\end{table}
