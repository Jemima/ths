...
\newglossaryentry{ABC}{name=ABC,
  description={\url{https://bitbucket.org/alanmi/abc/overview}}
  }
...
tseng & 52 & 122 & 385 & 1046\\
   ...
   \end{table}
   \fxfatal{Correct to use actual results} \subsection{Target
      Architecture} 
   \begin{figure}
   ...
   \section{Recovery Time}
    ...
    \fxwarning{Expand. Table of minimum recovery times}
   ...
   \caption{Running times for clma with a target recovery time of 2.5e-4s}\label{runningtimes}
   \end{table}
    \fxerror{Compare per partition values, promote summary from appendix to this section}
...
Mean &  &  &  &  & 1.51 & \\
   ...
   \fxfatal{Consistent capitalisation. Section, Chapter, etc always capitalised. Always refer to sections as they're numbered, not subsections}
